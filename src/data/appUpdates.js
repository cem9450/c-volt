export const APP_UPDATES = [
  ...
  version: "0.2.8",
  type: "update",
  title: "C-Volt ver 0.2.8",
  message:
    "배터리 영역 레이아웃을 개선했습니다. 실내 온도와 충전 상태를 다시 추가하고, 차량 이미지와 정보 카드가 겹치던 문제를 수정하여 모바일에서도 더욱 안정적으로 표시되도록 개선했습니다.",
  releasedAt:
    "2026-07-18T02:24+09:00",
},
  {
  id: "version-0-2-7",
  version: "0.2.7",
  ...
  releasedAt:
    "2026-07-18T02:18+09:00",
},
  {
  id: "version-0-2-6",
  version: "0.2.6",
  type: "update",
  title: "C-Volt ver 0.2.6",
  message:
    "차량 상태 화면을 Tesla 스타일로 개선했습니다. 문, 창문, 적재공간, 충전포트, 센트리, 연결 상태를 6개의 카드로 구성하고, 배터리 영역에 실내 온도와 충전 상태를 다시 추가했습니다.",
  releasedAt:
    "2026-07-18T01:59+09:00",
},
  {
  id: "version-0-2-5",
  version: "0.2.5",
  ...
  version: "0.2.0",
  type: "update",
  title: "C-Volt ver 0.2.0",
  message:
    "통계 화면을 업그레이드했습니다. 지난주 대비 주행거리 변화, 최근 7일 그래프와 최고 점수, 최장거리 및 최고 배터리 효율 기록을 확인할 수 있습니다.",
  releasedAt:
    "2026-07-16T20:30:00+09:00",
},
  {
  id: "version-0-1-18",
  version: "0.1.18",
  ...
  },
  {
    ...
    version: "0.1.10",
    type: "update",
    title: "C-Volt ver 0.1.10",
    message:
      "CEM Labs 푸터에 Connect. Evolve. Move. 슬로건을 추가하고 정렬과 화면 여백을 개선했습니다.",
    releasedAt:
  ...
  },
  {
    ...
    version: "0.1.2",
    type: "update",
    title: "C-Volt ver 0.1.2",
    message:
      "AI 운전 점수 계산과 게이지 화면을 개선했습니다.",
    releasedAt:
  ...
  },
  {
    ...
    version: "0.1.1",
    type: "update",
    title: "C-Volt ver 0.1.1",
    message:
      "프로필 및 알림 패널의 화면 깨짐 오류를 수정했습니다.",
    releasedAt:
      "2026-07-14T00:10:00+09:00",
  },
  {
    id: "version-0-1-0",
    version: "0.1.0",
