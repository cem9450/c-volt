export const APP_UPDATES = [
  ...
  message:
    "차량 상태 화면을 Tesla 스타일로 전면 리디자인했습니다. 문, 창문, 프렁크·트렁크, 충전포트, 센트리, 연결 상태를 6개의 상태 카드로 구성하고 배터리 영역 위로 재배치했습니다. 기존 차량 조회, 자동 새로고침, 주행 종료 이벤트, 주차 이벤트, 차량 이미지 및 배터리 기능은 그대로 유지됩니다.",
  releasedAt:
    "2026-07-18T01:53:00+09:00",
},
  {
  id: "version-0-2-5",
  version: "0.2.5",
